...
public class ProductCard extends VBox {
    ...
    public ProductCard(String id, String name, String description, float price, String category, int quantity) {
        ...
        this.getChildren().addAll(idLabel, nameLabel, descriptionLabel, priceLabel, categoryLabel, quantityLabel);
